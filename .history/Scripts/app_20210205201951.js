...
(function()
{
    ...
    function displayAbout()
    {
      ...
      let paragraph2Text = "I'm twenty years old and I'm currently enrolled in the Computer Programmer and Analysis course at Durham College. I spent one year at Ontario Tech University doing game development before switching into my current program. I enjoy programming and design, spending time with friends and going to music festivals. In future I aspire to be a succesful software developer and be able to travel too many countries and support my family.";

      let projectsDiv2 = document.getElementById("AboutAaronContent");

      let projectsP2 = document.createElement("p");

      projectsP2.textContent = paragraphOneText;
