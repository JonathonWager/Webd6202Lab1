...
(function()
{
    ...
    function Start()
    {
       ...
       // let navContentHumanResource = '<li class="nav-item"><a class="nav-link" aria-current="page" href="services.html"><i class="fas fa-map fa-lg"></i> Services</a></li>';
        let navContent = document.getElementsByTagName("li")[3];
        ...
        navContent.insertAdjacentElement(navContentHumanResourceLi);
        navContent.insertBefore(navContentHumanResourceA, navContent);
