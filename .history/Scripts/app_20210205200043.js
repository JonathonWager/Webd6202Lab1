...
(function()
{
    ...
    function displayServices()
    {
      ...
      let paragraphTwoText = "We have the ability to create interactive websites that will stand out and make you look professional. We can apply custom themes to style your website as well as make it an interactive website that is effeciently navigable.";

      let projectsDiv1 = document.getElementById("DatabaseDevelopmentContent");

      let projectsP1 = document.createElement("p");

      projectsP1.textContent = paragraphTwoText;
