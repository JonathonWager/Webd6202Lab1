...
(function()
{
    ...
    function Start()
    {
       ...
       // let navContentHumanResource = '<li class="nav-item"><a class="nav-link" aria-current="page" href="services.html"><i class="fas fa-map fa-lg"></i> Services</a></li>';
        let navContent = document.getElementsByTagName("li")[4];
        ...
        navContentHumanResourceA.innerHTML ='<i class="fas fa-cog fa-lg"></i>hiii';
        
        navContentHumanResourceLi.appendChild(navContentHumanResourceA);
        //navContent.insertBefore( navContentHumanResourceLi.nextSibling, navContent);
        //navContent.appendChild(navContentHumanResourceA);
        navContentHumanResourceLi.after(navContent);
