...
(function()
{
    ...
    function Start()
    {
        ...
        let navContentHumanResource = document.createElement("li");
        // Step 2. configure the element
        let navContentHumanResource.setAttribute("class", "nav-item");
        navContent.appendChild(navContentHumanResource);
